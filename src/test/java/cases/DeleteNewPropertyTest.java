...
import tasks.DeleteNewProperty;
...
public class DeleteNewPropertyTest {
	private static Logger logger = LogManager.getLogger(DeleteNewPropertyTest.class.getName()); // 定義Logger
	...
	public void validLoginTest() throws Exception {
		...
		DeleteNewProperty.deleteNewProperty(dr, userModel);
