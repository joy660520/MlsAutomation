...
public class SearchPropertyTest {
	private static Logger logger = LogManager.getLogger(SearchPropertyTest.class.getName()); // 定義Logger
	WebDriver dr;
	UserModel userModel;
	...
	public void validLoginTest() throws Exception {
		...
		SearchProperty.searchProperty(dr, userModel);
