...
public class AddDefaultLivetour {
	...
	public static void main(String[] args) throws Exception {
		...
		AddDefaultLivetour.addDefaultLivetour(dr, userModel);

	}

	public static void addDefaultLivetour(WebDriver dr, UserModel userModel) throws Exception {
		...
		boolean validCheck = dr
				.findElement(By.xpath(ReadProperties.getprop("element", "elements", "validlivetourcheck")))
				.isDisplayed();
		if (validCheck == true) {
