...
public class ValidUpdateHouseInfo {

	public static void main(String[] args) throws Exception {
		WebDriver dr = null;
		String urlcon = "https://mls-test.istaging.com/login";
	...
	public static void validUpdateHouseInfo(WebDriver dr, UserModel userModel) throws Exception {
		...
		Thread.sleep(3000);
		dr.findElement(By.xpath(ReadProperties.getprop("element", "elements", "sellingstatusinputbox"))).clear();
		dr.findElement(By.xpath(ReadProperties.getprop("element", "elements", "sellingstatusinputbox")))
				.sendKeys(Constants.ValidSellingStatus);

		boolean validCheck = dr.findElement(By.xpath(ReadProperties.getprop("element", "elements", "validtext")))
				.isDisplayed();
		if (validCheck == true) {
			System.out.println("銷售狀況：" + Constants.ValidSellingStatus);
			ScrollingElementToView.scrollingToSavebutton(dr);
		} else {
			System.out.println("can't find the element");
		}

		boolean result = validCheck;
