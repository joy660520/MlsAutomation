...
public class AddInvalidDefaultLivetour {
	...
	public static void addInvalidDefaultLivetour(WebDriver dr, UserModel userModel) throws Exception {
		...
		dr.findElement(By.xpath(ReadProperties.getprop("element", "elements", "defaultLivetourinputbox")))
				.sendKeys(Constants.InvalidDefaultLivetour);
		...
		boolean invalidCheck = dr
				.findElement(By.xpath(ReadProperties.getprop("element", "elements", "invalidlivetourcheck")))
				.isDisplayed();
